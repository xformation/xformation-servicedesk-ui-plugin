                ...
                <ModalBody style={{ height: 'calc(65vh - 20px)', overflowY: 'auto', overflowX: "hidden" }}>
                    <div className="ticket-details-popup-container">
                        ...
                        <div className="merge-ticket-container">
                            <div className="d-block ticket-heading">1 ticket selected, secondary ticket will be added to primary ticket.</div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-3 col-md-3 col-sm-3">
                                        <div className="form-check">
                                            ...
                                            <label className="form-check-label" htmlFor="MakePrimary">Make Primary</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    <div className="col-lg-6 col-md-6 col-sm-6">
                                        <div className="d-block form-check recipient">
                                            ...
                                            <label className="form-check-label" htmlFor="recipient">CC to Secondary ticket recipient.</label>
                                        </div>
                                    </div>
                                    <div className="col-lg-6 col-md-6 col-sm-6">
