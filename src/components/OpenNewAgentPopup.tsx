...
export class OpenNewAgentPopup extends React.Component<any, any> {
    steps: any;
    ...
    handleSubmit = (event: any) => {
        ...
        if (errorData.companyLogo.isValid && errorData.contactPhoto.isValid && errorData.fullName.isValid && errorData.title.isValid && errorData.companyId.isValid && errorData.companyLogo.isValid && errorData.companyName.isValid && errorData.description.isValid && errorData.notes.isValid && errorData.healthScore.isValid && errorData.domain.isValid && errorData.accountTier.isValid && errorData.renewalDate.isValid && errorData.industry.isValid && errorData.email.isValid ) {
            ...
            axios.post(config.ADD_AGENT_URL, formData, {
                headers: {
    ...
    validate = (isSubmitted: any) => {
        ...
        if (isSubmitted) {
            const { newCompanyFlag, oldCompanyFlag, contactPhoto, fullName, title, email, alternateEmail, workPhone, mobilePhone, twitter, uniqueExternalId, companyId, companyLogo, companyName, description, notes, domain, healthScore, accountTier, renewalDate, industry, agentDescription,address } = this.state;
            if (!contactPhoto) {
    ...
    render() {
        const { modal, isSubmitted, companyList, contactPhoto,contactPhotoUrl,companyLogoUrl, fullName, title, email, alternateEmail, workPhone, mobilePhone, twitter, uniqueExternalId, companyId, companyName, description, notes, domain, healthScore, accountTier, renewalDate, industry, oldCompanyFlag, newCompanyFlag, agentDescription, address } = this.state;
                    ...
                    <div className="d-block width-100 contact-popup-container">
                        <div className="d-block p-b-20 heading">
                            <div className="d-block width-100">
                                <h4 className="d-block"><i className="fa fa-user"></i> New Agent</h4>
                                <span className="d-block">When someone reaches out to you, they become a agent in your account. You can create companies and associate agents with them. <a href="#">Learn more.</a></span>
                            </div>
                        </div>
                        <div className="d-block width-100 upload-photo">
                            ...
                            <div className="d-inline-block v-a-top">
                                ...
                                <input type="file" id="contactPhoto" name="contactPhoto" className="contactPhoto" onChange={this.handleImageChange} />
                        ...
                        <div className="row">
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="form-group">
                                    ...
                                    <CustomTextareabox containerClass="form-group-inner" rows={1} inputClass="form-control textarea" htmlFor="agentDescription" id="agentDescription" name="agentDescription" placeholder="Enter agent description" value={agentDescription} onChange={this.handleStateChange} isValid={errorData.agentDescription.isValid} message={errorData.agentDescription.message} />
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-lg-12 col-md-12 col-sm-12">
                                <div className="form-group">
                                    ...
                                    <CustomTextbox containerClass="form-group-inner" inputClass="form-control" htmlFor="address" id="address" placeholder="Enter a address" name="address" value={address} onChange={this.handleStateChange} isValid={errorData.address.isValid} message={errorData.address.message} />
                                </div>
                            </div>
                        </div>
